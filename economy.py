...
from config import get_profile, create_starter_account, GEMS, WEAPONS, OWNER_ID
...
class EconomyEngine(commands.Cog):
    ...
    # --- ACCUMULATE INITIAL ACCOUNTS MECHANICS ---
    @commands.command(name="start")
    async def start_cmd(self, ctx, choice: str = None):
        """Initializes account data logs. Usage: s start bulbasaur/charmander/squirtle"""
